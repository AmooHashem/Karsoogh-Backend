...
class ExamAdmin(admin.ModelAdmin):
    ...
    def get_student_info_csv(self, request, queryset):
        ...
        writer = csv.writer(file)
        first_row = ['آخرین به‌روز‌رسانی', 'شناسه', 'کد ملی', 'نام', 'نام خانوادگی', 'جنسیت', 'ایمیل', 'شماره تلفن',
                     'شماره تلفن زاپاس', 'پایه', 'مدرسه', 'شماره تلفن مدرسه', 'شهر', 'استان', 'نام مدیر',
                     'شماره تلفن مدیر', 'وضعیت', 'تعداد پاسخ ارسال‌شده', 'نمره']
        ...
        for selected_exam_student in selected_exam_students:
            ...
            row = [selected_exam_student.update_date, student.id, student.national_code, student.first_name,
                   student.last_name, student.gender, student.email, student.phone1, student.phone2, student.grade,
                   ...
                   STUDENT_EXAM_STATUS[selected_exam_student.status][1], submitted_answers_count,
